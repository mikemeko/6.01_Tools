...
The \textit{protoboard layout} of a given schematic is the placement of
circuit pieces
...
\caption[Sample protoboard layout]{One possible protoboard layout for the
...
possible CMax layout for the schematic shown in Figure \ref{fig:schematic}.
...
Board (PCB) layout. To my findings, the owners of these tools do not publish
their

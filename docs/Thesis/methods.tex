...
respect the stated placement specifications.
We consider a few alternatives to finding a placement under these specifications.
...
We test that a given vertex is a goal vertex by verifying that its
